...
router.get("/all", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, article_model_1.default
                    .find({}, null, {})
                    .select({ "_id": 0, "__v": 0 })
                    .lean()
                    .exec()];
...
router.get("/:guid", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var per_page, page, args, result, _a;
